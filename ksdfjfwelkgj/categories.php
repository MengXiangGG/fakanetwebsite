...
<head>
    ...
    <style>
        ...
        .yesterday-sales { background: linear-gradient(135deg, #17a2b8 0%, #6f42c1 100%); }
            ...
            <div class="col-md-10">
                <div class="p-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            <div class="sales-card yesterday-sales">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <div class="stat-number">¥<?php echo number_format($sales_summary['total_yesterday_sales'] ?? 0, 2); ?></div>
                                        <div class="stat-label">昨日销售额</div>
                                        <small>订单: <?php echo $sales_summary['total_yesterday_orders'] ?? 0; ?> 笔</small>
                                    </div>
                                    <i class="fas fa-moon fa-2x opacity-50"></i>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center">
                                        <div class="me-3">
                                            <?php
                                            $today_sales = $sales_summary['total_today_sales'] ?? 0;
                                            $yesterday_sales = $sales_summary['total_yesterday_sales'] ?? 0;
                                            $growth_rate = calculateSalesGrowth($today_sales, $yesterday_sales);
                                            $trend = getSalesTrendIcon($today_sales, $yesterday_sales);
                                            ?>
                                            <i class="<?php echo $trend['icon']; ?> fa-2x text-<?php echo $trend['color']; ?>"></i>
                                        </div>
                                        <div>
                                            <h4 class="mb-1 text-<?php echo $trend['color']; ?>">
                                                <?php echo $growth_rate; ?>%
                                            </h4>
                                            <small class="text-muted">较昨日<?php echo $trend['text']; ?></small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-1 text-primary">
                                                ¥<?php echo number_format($today_sales - $yesterday_sales, 2); ?>
                                            </h4>
                                            <small class="text-muted">较昨日差额</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-1 text-info">
                                                <?php echo $today_sales > 0 ? round(($today_sales / ($today_sales + $yesterday_sales)) * 100, 1) : 0; ?>%
                                            </h4>
                                            <small class="text-muted">今日占比</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($categories as $category): 
                                            ...
                                            // 计算增长趋势
                                            $growth_rate = calculateSalesGrowth($stat['today_sales'], $stat['yesterday_sales']);
                                            $trend = getSalesTrendIcon($stat['today_sales'], $stat['yesterday_sales']);
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="sales-info">
                                                    <div class="mb-1">
                                                        ...
                                                        <span class="badge bg-<?php echo $trend['color']; ?> growth-badge">
                                                            <i class="<?php echo $trend['icon']; ?> me-1"></i><?php echo $growth_rate; ?>%
                                                        </span>
                                                    ...
                                                    <div class="mb-1">
                                                        <small class="text-muted">昨日:</small>
                                                        <strong class="text-info">¥<?php echo number_format($stat['yesterday_sales'], 2); ?></strong>
                                                        <span class="badge bg-dark sales-badge">
                                                            <?php echo $stat['yesterday_orders']; ?>单
                                                        </span>
                                                    </div>
                                                    <div>
